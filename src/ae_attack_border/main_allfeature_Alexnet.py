...
if __name__ == '__main__':
    ...
    for epsilon in EPSILON_ALL:
        ...
        AE_MODEL_H5 = f"/Users/ducanhnguyen/Documents/mydeepconcolic/result/ae-attack-border/Alexnet/allfeature/autoencoder_models/ae4dnn_Alexnet_9_7weight={epsilon}_1000autoencoder.h5"
    ...
    for step in steps:
        for ranking_algorithm in ranking_algorithms:
            ...
            output_folder = f"/Users/ducanhnguyen/Documents/mydeepconcolic/optimization_batch3/Alexnet/trash_ae_allfeature_{MODEL}_{ORI_LABEL}to{TARGET_LABEL}_ranking{name}_step{step}"
