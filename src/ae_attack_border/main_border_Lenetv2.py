...
from src.ae_attack_border.ae_reader import get_X_attack, generate_adv_for_single_attack_SALIENCE, \
    generate_adv_for_single_attack_ALL_FEATURE, generate_adv_for_single_attack_BORDER_PATTERN
...
if __name__ == '__main__':
    ...
    type_attack = "border" #saliency, border, all
    ...
    for epsilon in EPSILON_ALL:
        ...
        AE_MODEL_H5 = f"/Users/ducanhnguyen/Documents/mydeepconcolic/result/ae-attack-border/Lenet_v2/edge/autoencoder_models/ae_border_Lenet_v2_9_4weight={epsilon}_1000autoencoder.h5"
    ...
    for step in steps:
        for ranking_algorithm in ranking_algorithms:
            ...
            output_folder = f"/Users/ducanhnguyen/Documents/mydeepconcolic/optimization_batch3/Lenet_v2/ae_border_{MODEL}_{ORI_LABEL}to{TARGET_LABEL}_ranking{name}_step{step}"
