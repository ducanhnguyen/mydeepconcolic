...
if __name__ == '__main__':
    ...
    for epsilon in EPSILON_ALL:
        ...
        AE_MODEL_H5 = f"/Users/ducanhnguyen/Documents/mydeepconcolic/result/ae-attack-border/Alexnet/saliency/autoencoder_models/ae_slience_map_Alexnet_9_7weight={epsilon}_1000autoencoder.h5"
    ...
    ranking_algorithms = [RANKING_ALGORITHM.COI, #RANKING_ALGORITHM.RANDOM, #RANKING_ALGORITHM.JSMA_KA, RANKING_ALGORITHM.JSMA
                          ]
    size = 500
    steps = [6]
    dict_ranking = dict()
    for step in steps:
        for ranking_algorithm in ranking_algorithms:
            ...
            output_folder = f"/Users/ducanhnguyen/Documents/mydeepconcolic/optimization_batch3/Alexnet/trash_ae_saliency_{MODEL}_{ORI_LABEL}to{TARGET_LABEL}_ranking{name}_step{step}"
