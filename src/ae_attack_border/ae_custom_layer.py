...
class concate_start_to_end(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        important_pixels_array = tf.Variable(important_pixels_array, trainable=False, dtype='float32')
        ...
        not_important_pixel_array = tf.Variable(not_important_pixel_array, trainable=False, dtype='float32')
