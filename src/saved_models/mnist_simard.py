...
acc train set = 1
acc test set = 0.96121
'''


class MNIST_SIMARD(abstract_dataset):
...
if __name__ == '__main__':
    ...
    # mnist.train_model(train=True, kernel_path='../saved_models/mnist_simard.h5',
    #                   model_path='../saved_models/mnist_simard.json',
