...
public class Z3SolutionParser implements IZ3SolutionParser {
	...
	public static void main(String[] args) {
		// String Z3Solution = "(error \"line 6 column 30: invalid function application,
		// wrong number of arguments\")\nsat\n(model\n\n (define-fun tvwp ((x!1 Int)
		// (x!2 Int)) Int\n (ite (and (= x!1 0) (= x!2 0)) 10\n 10))\n)";
		
		String arg0= "/Users/ducanhnguyen/Documents/python/pycharm/mydeepconcolic/data/solution.txt";
		String arg1 = "/Users/ducanhnguyen/Documents/python/pycharm/mydeepconcolic/data/norm_solution.txt"; 
				
		String Z3Solution = Utils.readFileContent(args[0]);
		String solution = new Z3SolutionParser().getSolution(Z3Solution);
		Utils.writeContentToFile(solution, args[1]);
	}
				...
				case VALUE_ID:
					if (!ignoreEndLine) {
						...
						try {
							...
							// Can not parse line because the line is not sufficient.
							// Example: " (/ 3898452512613114311193088088900546489977353.0
							// 2000000000000000000000000000000000000000000.0))"

							// get the next line, merge them to have a sufficient line.
							String nextLine = "";
							if (idx < lineList.length - 1)
								nextLine = lineList[idx + 1];
							line += nextLine;
